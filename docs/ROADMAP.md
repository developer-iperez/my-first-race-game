...
- ✅ Pantalla de inicio (título + "pulsa para empezar", con ajustes de
  conducción accesibles antes de correr) y cuenta atrás de salida 3·2·1·¡YA!
- ✅ Mejor vuelta guardada entre sesiones (por circuito+coche)
- ✅ Ajustes de conducción personalizables: sliders de velocidad máxima,
  aceleración y agarre (sustituyen a los antiguos niveles de dificultad),
  y opción de sonido activado/desactivado
